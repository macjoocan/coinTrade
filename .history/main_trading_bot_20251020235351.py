            ...
            try:
                ...
                if order:
                    ...
                    if order_detail:
                        ...
                        # 평균 체결가 계산
                        if trades_count > 0 and executed_volume > 0:
                            received_amount = float(order_detail.get('price', 0)) * executed_volume - paid_fee
                            actual_price = received_amount / executed_volume if executed_volume > 0 else current_price
                            actual_quantity = executed_volume
                        else:
                            actual_price = current_price
                            actual_quantity = quantity
                    ...
                    pnl = (actual_price - entry_price) * actual_quantity
                    notional = entry_price * actual_quantity
