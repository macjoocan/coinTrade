...
class PartialExitManager:
    ...
    def __init__(self):
        ...
        self.partial_exit_levels = [
            {'profit': 0.008, 'exit_ratio': 0.25, 'min_hold_time': 900},   # +0.8% → 40% (15분)
            {'profit': 0.012, 'exit_ratio': 0.30, 'min_hold_time': 0},     # +1.2% → 30%
            {'profit': 0.020, 'exit_ratio': 0.30, 'min_hold_time': 0},     # +2.0% → 30%
        ]
