...
# ==========================================
# 💧 물타기 (Averaging Down) 설정
# ==========================================
AVERAGING_DOWN_CONFIG = {
    'enabled': True,  # ✅ True로 설정하면 물타기 활성화
    
    # 기본 설정
    'trigger_loss_rate': -0.008,      # -1.2 하락 시 물타기
    'max_averaging_count': 3,        # 최대 2번까지만 물타기
    'averaging_size_ratio': 1.0,     # 원래 포지션과 동일한 금액
    
    # 안전장치
    'max_total_loss': -0.05,         # 총 -8% 이상 손실 시 물타기 중단
    'min_balance_ratio': 0.3,        # 잔고의 30% 이상 필요
    
    # 제한 조건
    'only_stable_coins': False,       # 안정 코인만 (BTC, ETH, SOL 등)
    'disable_on_bear_market': True, # 약세장에서도 허용 (False)
...
STRATEGY_PRESETS = {
    ...
    'balanced': {
        'entry_score_threshold': 4.5,       # ✅ 4.0 → 6.5 (대폭 상향!)
    ...
    'aggressive': {
        ...
        # 💡 단기 기술적 신호 최대 활용
        'signal_weights': {
            'technical': 0.80,   # 기술적 분석 최대
            'mtf': 0.20,         # MTF 줄임
            'ml': 0           # ML 최소
        },
        
        'max_positions': 4,                 # 많은 포지션
        'max_position_size': 0.5,          # 큰 포지션
