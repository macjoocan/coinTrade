...
ADVANCED_CONFIG = {
    'entry_score_threshold': 5.0,    # ✅ 6.5 → 5.0 (완화)
...
SIGNAL_INTEGRATION_CONFIG = {
    ...
    # ✅ 시장 상황별 조정 완화
    'market_adjustment': {
        'bullish': -1.0,    # ✅ 상승장에서 4.0점이면 진입
        'neutral': 0.0,     # ✅ 중립장에서 5.0점이면 진입
        'bearish': +2.0,    # ✅ 약세장에서 7.0점 필요
    },
...
STRATEGY_PRESETS = {
    ...
    'balanced': {
        'entry_score_threshold': 5.0,   # ✅ 6.5 → 5.0
        'mtf_min_score': 5.5,           # ✅ 6.5 → 5.5
