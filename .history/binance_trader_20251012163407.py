...
class Config:
    ...
    def __init__(self):
        # API 설정
        self.API_KEY = "nqa88kmvhH2FjmVFoOuYm777wr2JOVtziES5Zz9d1EXCWFFvmoB1jqjDTdyE5EsW"
        self.API_SECRET = "7BcORIFfKIyB13wDkIc6UmDZeVKJWHpuhlJGb7BV33wrHVZs7m6lcpTfEkJgQJlL"
        self.USE_TESTNET = True  # 테스트넷 사용 여부
...
class BinanceAPI:
    ...
    def __init__(self, config, logger):
        ...
        if config.USE_TESTNET:
            ...
            self.logger.warning("실제 거래 모드로 연결")
